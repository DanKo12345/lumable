...
![LumaBLE 0.4.4 屏幕与音乐预览](docs/images/lumable-screen-preview-0.4.4-dark.png)
...
- RGB、亮度、色温和电源控制。
- 场景、快捷模式、控制器效果和应用动画。
- “屏幕 + 音乐”模式：屏幕决定颜色，音乐根据节拍强弱改变亮度。
- 也可以单独使用屏幕同步或音乐同步。
- 按时间、前台应用、空闲时间、灯带连接和 Windows 状态触发自动化。
- 通过托盘快捷操作和可选的全局快捷键控制灯光。
- 安全备份场景、规则、分组和设置，不包含设备地址或密钥。
